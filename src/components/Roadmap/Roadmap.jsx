		...
		<div className='roadmap'>
			...
			<div className='roadmap-item'>
				...
				<p>
					...
					grants you access to our land and exclusive events as well as receive
					exclusive airdrops.
				</p>
			</div>
			<div className='roadmap-item'>
				...
				<p>
					With the future of CryptoHunkz being a strong active community we will
					be building an Arena on our Sandbox land to host various Events,
			...
			<div className='roadmap-item'>
				...
				<p>
					...
					exclusively for VX holders to use and show off in the metaverse. (Ex.
					Motorcycles, Animated Stoagies, Apparel){' '}
				</p>
			</div>
		</div>
	);
